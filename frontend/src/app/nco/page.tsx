...
import { Brain, Target, Lightbulb, BookOpen, Clock, FileQuestion, CheckCircle, Award, Medal, Trophy, Calendar, Building2, User } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <p className="text-lg sm:text-xl text-foreground/80 leading-relaxed font-light">
                The National Capability Olympiad (NCO) is a rigorous, standardized examination that evaluates students&apos; ability to think critically, reason systematically, and apply knowledge in unfamiliar contexts.
              </p>
              <p className="text-base sm:text-lg text-foreground/70 leading-relaxed">
                Unlike conventional assessments focused on recall, NCO provides a comparative benchmark for measuring foundational cognitive capabilities essential for excellence in the modern era.
              </p>
              <div className="bg-background border border-border p-8 rounded-3xl mt-8 shadow-sm">
                <p className="text-primary text-lg font-serif italic leading-relaxed">
                  &ldquo;NCO serves as a national standard for measuring capability that transcends subject-bound and traditional grading systems.&rdquo;
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            <p className="text-lg text-foreground/80 font-light italic">
              All participants receive a detailed <strong className="text-primary font-serif font-normal underline decoration-primary/20 underline-offset-4">Capability Profile Report</strong> outlining strengths and comparative benchmarks.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-primary-foreground/60 max-w-2xl mx-auto mb-16 text-lg sm:text-xl font-light leading-relaxed">
                Join the network of elite institutions establishing a new benchmark for student capability and cognitive excellence across the nation.
              </p>
